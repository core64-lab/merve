...
def generate_build_and_push_workflow(
    ...
    try:
        ...
        workflow_version = "1.0"  # Increment when workflow structure changes incompatibly
    except:
        mlserver_version = "unknown"
        workflow_version = "1.0"

    template = f"""# Generated by MLServer {mlserver_version}
...
def validate_workflow_compatibility(
    ...
    try:
        ...
        current_workflow_version = "1.0"  # Should match generate_build_and_push_workflow()
    except:
        current_mlserver_version = "unknown"
        current_workflow_version = "1.0"
